...
// hexshop theme support options calling here
function hexshop_theme_support(){
    ...
    // hexshop all the menu
    register_nav_menus( array(
        'primary-menu' => __( 'Primary Menu', 'hexshop' ),
        'social-menu' => __( 'Social Menu', 'hexshop' ),
    ) );
